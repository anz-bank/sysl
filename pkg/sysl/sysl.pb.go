...
type Type_Constraint struct {
	...
	BitWidth   int32                       `protobuf:"varint,6,opt,name=bitWidth,proto3" json:"bitWidth,omitempty"`
}
...
var file_sysl_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x62, 0x69, 0x74, 0x57, 0x69, 0x64,
