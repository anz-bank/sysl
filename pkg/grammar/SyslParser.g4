...
http_path_part : ((name_str | NativeDataTypes | DIGITS)+ (QN Name EQ Name (AMP Name EQ Name)*)?);
http_path_var_with_type : CURLY_OPEN http_path_part LESS_COLON sequence_of? (NativeDataTypes | name_str | reference) CURLY_CLOSE;
