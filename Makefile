...
embed-arrai:
	cd ./pkg/importer/avro && arrai run ./../../arrai/concat.arrai transformer.arrai > full_avro_transformer.arrai && arrai run full_avro_transformer.go.arrai > full_avro_transformer_arrai.go
