...
""",Image = ""},
      ...
      {CodeEmpty= true,CodeLeading= false,CodeRun= true,CodeRendered="""""",DocsRendered= """<p>This demonstrates how to develop a simple sysl app without any dependencies or external callsNote; most of the tutorials in the &ldquo;Code-Generation&rdquo; section are going to have a lot of repeated codeBut everything is included in each tutorial for completeness</p>
""",Image = ""},
...
""",Image = ""},
    ...
    <span class="p">!</span><span class="kd">type</span> <span class="nx">Stuff</span><span class="p">:</span>
        <span class="nx">Content</span> <span class="p">&lt;:</span> <span class="kt">string</span><span class="p">:</span>
            <span class="err">@</span><span class="nx">json_tag</span> <span class="p">=</span> <span class="s">&#34;Content&#34;</span>
    <span class="p">!</span><span class="kd">type</span> <span class="nx">Foo</span><span class="p">:</span>
        <span class="nx">Content</span> <span class="p">&lt;:</span> <span class="kt">int</span></pre>""",DocsRendered= """<p>Wrap the types in sysl types</p>
""",Image = ""},
...
""",Image = ""},
    ...
    <span class="o">/</span><span class="nx">foobar</span><span class="p">:</span>
        <span class="nx">GET</span><span class="p">:</span>
            <span class="k">return</span> <span class="nx">no</span> <span class="p">&lt;:</span> <span class="nx">Foo</span></pre>""",DocsRendered= """<p>Second endpoint returns a Foo type</p>
""",Image = ""},
...
""",Image = ""},
    ...
    <span class="s">&#34;context&#34;</span></pre>""",DocsRendered= """""",Image = ""},
      ...
      {CodeEmpty= false,CodeLeading= true,CodeRun= false,CodeRendered="""<pre class="chroma">
    <span class="nx">simple</span> <span class="s">&#34;github.service.anz/sysl/syslbyexample/_examples/Code-Generation/gen/simple&#34;</span>
<span class="p">)</span></pre>""",DocsRendered= """<p>the simple package is the code generated sysl in our gen directory</p>
""",Image = ""},

      {CodeEmpty= false,CodeLeading= true,CodeRun= false,CodeRendered="""<pre class="chroma">
<span class="kd">func</span> <span class="nf">GetTestList</span><span class="p">(</span><span class="nx">ctx</span> <span class="nx">context</span><span class="p">.</span><span class="nx">Context</span><span class="p">,</span> <span class="nx">req</span> <span class="o">*</span><span class="nx">simple</span><span class="p">.</span><span class="nx">GetTestListRequest</span><span class="p">,</span> <span class="nx">client</span> <span class="nx">simple</span><span class="p">.</span><span class="nx">GetTestListClient</span><span class="p">)</span> <span class="p">(</span><span class="o">*</span><span class="nx">simple</span><span class="p">.</span><span class="nx">Stuff</span><span class="p">,</span> <span class="kt">error</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">return</span> <span class="o">&amp;</span><span class="nx">simple</span><span class="p">.</span><span class="nx">Stuff</span><span class="p">{</span><span class="nx">Content</span><span class="p">:</span> <span class="s">&#34;9q834noxfo348t908qdjr9w8no4rmq34r&#34;</span><span class="p">},</span> <span class="kc">nil</span>
<span class="p">}</span></pre>""",DocsRendered= """<p>GetTestList refers to the first GET endpoint we specify in our sysl model</p>
""",Image = ""},

      {CodeEmpty= false,CodeLeading= false,CodeRun= false,CodeRendered="""<pre class="chroma">
<span class="kd">func</span> <span class="nf">GetFoobarList</span><span class="p">(</span><span class="nx">ctx</span> <span class="nx">context</span><span class="p">.</span><span class="nx">Context</span><span class="p">,</span> <span class="nx">req</span> <span class="o">*</span><span class="nx">simple</span><span class="p">.</span><span class="nx">GetFoobarListRequest</span><span class="p">,</span> <span class="nx">client</span> <span class="nx">simple</span><span class="p">.</span><span class="nx">GetFoobarListClient</span><span class="p">)</span> <span class="p">(</span><span class="o">*</span><span class="nx">simple</span><span class="p">.</span><span class="nx">Foo</span><span class="p">,</span> <span class="kt">error</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">return</span> <span class="o">&amp;</span><span class="nx">simple</span><span class="p">.</span><span class="nx">Foo</span><span class="p">{</span><span class="nx">Content</span><span class="p">:</span> <span class="mi">123123</span><span class="p">},</span> <span class="kc">nil</span>
<span class="p">}</span></pre>""",DocsRendered= """<p>GetFoobarList refers to the second GET endpoint we specify in our sysl model</p>
""",Image = ""},
...
""",Image = ""},
    ...
    <span class="s">&#34;github.service.anz/sysl/syslbyexample/_examples/Code-Generation/gen/simple&#34;</span>
...
<span class="p">}</span>
<span class="kd">func</span> <span class="nf">SetJSONContentType</span><span class="p">(</span><span class="nx">ctx</span> <span class="nx">context</span><span class="p">.</span><span class="nx">Context</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">headermap</span><span class="p">,</span> <span class="nx">_</span> <span class="o">:=</span> <span class="nx">common</span><span class="p">.</span><span class="nf">RespHeaderAndStatusFromContext</span><span class="p">(</span><span class="nx">ctx</span><span class="p">)</span>
    <span class="nx">headermap</span><span class="p">.</span><span class="nf">Add</span><span class="p">(</span><span class="s">&#34;Content-Type&#34;</span><span class="p">,</span> <span class="s">&#34;application/json&#34;</span><span class="p">)</span>
<span class="p">}</span>
<span class="kd">func</span> <span class="nf">LoadServices</span><span class="p">(</span><span class="nx">ctx</span> <span class="nx">context</span><span class="p">.</span><span class="nx">Context</span><span class="p">)</span> <span class="kt">error</span> <span class="p">{</span>
    <span class="nx">router</span> <span class="o">:=</span> <span class="nx">chi</span><span class="p">.</span><span class="nf">NewRouter</span><span class="p">()</span></pre>""",DocsRendered= """<p>simpleServiceInterface is the struct which is composed of our functions we wrote in <code>methods.go</code>Struct embedding is used for the Service interface (yes, not interfaces); GetStuffList and GetFoobarList are the functions we wrote</p>
""",Image = ""},

      {CodeEmpty= false,CodeLeading= true,CodeRun= false,CodeRendered="""<pre class="chroma">    <span class="nx">simpleServiceInterface</span> <span class="o">:=</span> <span class="nx">simple</span><span class="p">.</span><span class="nx">ServiceInterface</span><span class="p">{</span>
        <span class="nx">GetTestList</span><span class="p">:</span>   <span class="nx">GetTestList</span><span class="p">,</span>
    ...
    <span class="p">}</span></pre>""",DocsRendered= """""",Image = ""},
      ...
      {CodeEmpty= false,CodeLeading= true,CodeRun= false,CodeRendered="""<pre class="chroma">
    <span class="nx">serviceHandler</span> <span class="o">:=</span> <span class="nx">simple</span><span class="p">.</span><span class="nf">NewServiceHandler</span><span class="p">(</span><span class="nx">genCallbacks</span><span class="p">,</span> <span class="o">&amp;</span><span class="nx">simpleServiceInterface</span><span class="p">)</span></pre>""",DocsRendered= """<p>Service Handler</p>
""",Image = ""},
...
""",Image = ""},
    ...
    <span class="nx">flag</span><span class="p">.</span><span class="nf">StringVar</span><span class="p">(</span><span class="o">&amp;</span><span class="nx">serverAddress</span><span class="p">,</span> <span class="s">&#34;p&#34;</span><span class="p">,</span> <span class="s">&#34;:80&#34;</span><span class="p">,</span> <span class="s">&#34;Specify server address&#34;</span><span class="p">)</span>
...
""",Image = ""},
    ...
    <span class="s">&#34;context&#34;</span></pre>""",DocsRendered= """""",Image = ""},
      ...
      {CodeEmpty= false,CodeLeading= true,CodeRun= false,CodeRendered="""<pre class="chroma">    <span class="s">&#34;github.service.anz/sysl/syslbyexample/_examples/Code-Generation/implementation&#34;</span>
<span class="p">)</span></pre>""",DocsRendered= """""",Image = ""},
