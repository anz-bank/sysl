...
import (
	...
	"github.com/anz-bank/sysl/internal/lsp/baz"
	_ "github.com/anz-bank/sysl/internal/lsp/signature" // provide type information for unimported completions in the other file
)
