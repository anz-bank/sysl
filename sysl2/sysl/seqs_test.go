...
func TestGenerateSequenceDiagramsWithAttributes(t *testing.T) {
	m, _ := Parse("sequence_diagram_attribs.sysl", "./tests/")
	l := &labeler{}
	p := &sequenceDiagParam{}
...
func TestDoConstructSequenceDiagramsNoSyslSdFilters(t *testing.T) {
	tests := []struct {
		...
		{
			"Case-No endpoints",
			sdArgs{root_model: "./tests/", modules: "sequence_diagram_test.sysl"},
		},
		{
			"Case-Set endpoints",
			sdArgs{
