...
ALTER TABLE Breed ALTER COLUMN breedId TYPE ;
...
ALTER TABLE Pet ALTER COLUMN petId TYPE ;
...
ALTER TABLE Employee ALTER COLUMN employeeId TYPE ;
ALTER TABLE EmployeeTendsPet ALTER COLUMN employeeId TYPE ;
