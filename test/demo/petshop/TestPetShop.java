...
public class TestPetShop {
  ...
  public void testPetShop() throws XMLStreamException {
    ...
    assertEquals(new Integer(1), new Integer(
      labrador.toPetView().toEmployeeTendsPetView().toEmployeeView().size()));
    assertEquals(new Integer(2), new Integer(
      doberman.toPetView().toEmployeeTendsPetView().toEmployeeView().size()));
  ...
  public void testAttributes() throws XMLStreamException {
    io.sysl.demo.petshop.api.Employee employee =
      new io.sysl.demo.petshop.api.Employee();
    employee.setIndex(1);
    employee.setName("Anne");

    assertEquals(
      "<Employee index=\"1\"><name>Anne</name></Employee>", toXml(employee));
  }
  ...
  private Employee newEmployee(
      PetShopFacade facade, String name, int y, int m, int d) {
  ...
  private Breed newBreed(
      PetShopFacade facade, String name, String species, int numLegs) {
  ...
  private Pet newPet(
      PetShopFacade facade, String name, Breed breed,
      int y, int m, int d, int numLegs) {
    LocalDate dob = new LocalDate(y, m, d);
  ...
  private EmployeeTendsPet newTends(
      PetShopFacade facade, Employee employee, Pet pet) {
  ...
  private String toXml(io.sysl.demo.petshop.api.Employee employee)
